...
// 	// std::vector<
// 	std::vector<SimplicialTreeNode_ptr> TreeLoopTracker_single;
	
// 	for(int j=0;j<simplex_vertices.size();j++){
// 		for(int i=0;i<simplex_vertices.at(j).size();i++){
// 			// SimplicialTreeNode_ptr 	
// 			simplex = domain_complex.find(simplex_vertices.at(j).at(i));
// 			TreeLoopTracker_single.push_back(simplex);
// 		}
// 		tlt_ptr.push_back(TreeLoopTracker_single);
// 	}
// }
