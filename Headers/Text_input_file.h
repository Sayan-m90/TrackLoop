...
#ifndef HEADERS_TEXT_INPUT_FILE
#define HEADERS_TEXT_INPUT_FILE
...
namespace Headers
{
	...
	public:
		...
		Text_input_file( char const *path_cstring_ );
		~Text_input_file();
	...
	inline
	Text_input_file::Text_input_file( char const *path_cstring_ )
		: File( path_cstring_ ), m_p_file( fopen( path_cstring_, "r" ) )
	{
		if ( m_p_file == 0 )
		{
